...
import { EMPTY_SEGMENT, SEGMENT_FIELDS, type SegmentField, type SegmentFieldType } from "./fields";
export { EMPTY_SEGMENT, SEGMENT_FIELDS, type SegmentField, type SegmentFieldType };
